...
export class MigracionCuenta1640222892887 implements MigrationInterface {
    name = 'MigracionCuenta1640222892887';

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "account" ("id" SERIAL NOT NULL, "nombre" character varying NOT NULL DEFAULT 'Cuenta de ahorros', "numeroCuenta" integer NOT NULL, "saldo" bigint NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(6), "updatedAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(6), "usuarioId" integer, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`, undefined);
